<script>
    ...
    import { ChartPieSolid, GridSolid, MailBoxSolid, ShoppingBagSolid, ArrowRightToBracketOutline, EditOutline, UserSolid,  FireSolid, BookSolid, RestoreWindowOutline, LifeSaverSolid } from 'flowbite-svelte-icons';
